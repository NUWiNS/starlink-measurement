...
from scripts.bos_la_2024_trip.configs import ROOT_DIR
from scripts.bos_la_2024_trip.labels import DatasetLabel
from scripts.bos_la_2024_trip.separate_dataset import read_dataset
from scripts.logging_utils import create_logger
from scripts.ping_utils import extract_ping_data, find_icmp_ping_files_by_dir_list
...
def parse_ping_for_operator(operator: str):
    ...
    ping_files = find_icmp_ping_files_by_dir_list(dir_list)
    excluded_files = []
