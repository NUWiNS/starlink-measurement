...
from scripts.hawaii_starlink_trip.separate_dataset import read_dataset, DatasetLabel

starlink_dir = os.path.join(ROOT_DIR, 'raw/starlink')
...
ref_df_path_map = {
    ...
    'tmobile': {
        'tcp_downlink': os.path.join(ROOT_DIR, 'xcal/sizhe_new_data', f'tmobile_xcal_smart_tput.csv'),
        'tcp_uplink': os.path.join(ROOT_DIR, 'xcal/sizhe_new_data', f'tmobile_xcal_smart_tput.csv'),
        'ping': os.path.join(ROOT_DIR, 'ping/sizhe_new_data', f'tmobile_ping.csv'),
    },
}
