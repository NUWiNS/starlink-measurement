...
def main():
    ...
    plot_tput_direction_by_area(direction='downlink', direction_label='Downlink', x_step=50)
    plot_tput_direction_by_area(direction='uplink', direction_label='Uplink', x_step=25)
